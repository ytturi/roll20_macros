...
COMPLEX_MACROS = {
    ...
    'Current Weight': {
        'base': '{message_target} &{{template:default}} {{{{name=Current weight}}}} {characters_parsed_template}',
...
def generate_complex_macro(macro_name: str, characters: List[str], player: bool):
